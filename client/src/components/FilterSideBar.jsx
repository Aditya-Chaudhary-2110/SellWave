...
const FilterSideBar = ({
  ...
  return (
    <div
      className={`
    fixed sm:sticky top-0 sm:top-24 left-0
    h-screen sm:h-fit
    w-72 md:min-w-75
    ...
    ${showFilterPhone ? "translate-x-0" : "-translate-x-full"}
    sm:translate-x-0
  `}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <X
              ...
              className="size-6 text-gray-500 hover:text-gray-700 p-1 hover:bg-gray-100 transition-colors cursor-pointer"
            />
