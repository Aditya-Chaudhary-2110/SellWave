  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
      ...
      {listing.featured && (
        <>
          <p className="py-1" />
          <div className="absolute top-0 left-0 w-full bg-linear-to-r from-pink-500 to-purple-500 text-white text-center text-xs font-semibold py-1 tracking-wide uppercase">
            Featured
          </div>
        </>
      )}
      ...
      <div className="p-5 pt-8">
        ...
        {/* tags & location */}
        <div className="flex items-center gap-3 mb-3">
          <span className="text-xs font-medium bg-pink-100 text-pick-600 px-3 py-1 rounded-full capitalize">
            {listing.niche}
          </span>
          {listing.country && (
