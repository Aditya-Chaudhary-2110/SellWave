...
const WithdrawalDetail = ({ data, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur z-100 flex items-center justify-center sm:p-4">
      <div className="bg-white sm:rounded-lg shadow-2xl w-full max-w-xl h-screen sm:h-120 flex flex-col">
        {/* Header */}
        ...
        {!data.isWithdrawn && (
          <div className="p-4 border-t border-gray-200 flex items-center justify-end gap-2">
            <button
              ...
              className="text-sm bg-indigo-500 text-white font-medium py-2 px-4 rounded-md flex items-center gap-2"
            >
              Mark as withdrawn
            </button>
          </div>
