        ...
        <div className="bg-white min-w-full md:min-w-92.5 rounded-xl border border-gray-200 p-5 max-md:mb-10">
          ...
          {listing.isCredentialChanged && (
            <button
              ...
              className="w-full bg-purple-600 text-white mt-2 py-2 rounded-lg hover:bg-purple-700 transition text-sm font-medium flex items-center justify-center gap-2"
            >
