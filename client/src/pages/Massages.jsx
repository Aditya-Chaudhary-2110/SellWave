...
import { dummyChat } from "../assets/assets";
...
const Massages = () => {
  ...
  const filteredChats = useMemo(() => {
    ...
    return chats.filter((chat) => {
      const chatUser =
        chat.UserId === user?.id ? chat?.ownerUser : chat?.chatUser;
      return (
  ...
  return (
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="py-10">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-grey-800 mb-2">Messages</h1>
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        className={`text-sm truncate ${!chat.isLastMessageRead && chat.lastMessageSenderId !== user?.id ? "text-indigo-600 font-medium" : "text-gray-500"}`}
                      >
